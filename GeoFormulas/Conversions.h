...
GEOAPI  inline double FeetToMeters(const double dFeet) { return dFeet * kMetersPerFoot; }

// return the conversion from meters to feet { meters / 0.3048 )
GEOAPI  inline double MetersToFeet(const double dMeters) { return dMeters * kFeetPerMeter; }

// returns the conversion from feet to nautical miles (  feet * (0.3048 / 1852.0) )
GEOAPI  inline double FeetToNm(const double dFeet) { return dFeet * kNmPerFoot; }

// returns the conversion from nautical miles to feet ( nm * (1852.0 / 0.3048) )
GEOAPI  inline double NmToFeet(const double dNm) { return dNm * kFeetPerNm; }

// returns the conversion from meters to nautical miles ( meters / 1852.0 )
GEOAPI  inline double MetersToNm(const double dMeters) { return dMeters * kNmPerMeter; }

// returns the conversion from nautical miles to meters ( nm * 1852.0; )
GEOAPI  inline double NmToMeters(const double dNm) { return dNm * kMetersPerNm; }


//////////////////////////////////////////////////////////////////////////
// Angular conversion functions
GEOAPI  inline double Deg2Rad(const double dVal) { return dVal * (M_PI / 180.0); }
GEOAPI  inline double Rad2Deg(const double dVal) { return dVal * (180.0 / M_PI); }


//////////////////////////////////////////////////////////////////////////
// Temperature conversion functions
// returns the conversion from Celsius to Fahrenheit
GEOAPI  inline double CelsiusToFahrenheit(const double dCelsius) { return 1.8 * dCelsius + 32.0; }

// returns the conversion from Fahrenheit to Celsius
GEOAPI  inline double FahrenheitToCelsius(const double dFahrenheit) { return (dFahrenheit - 32) / 1.8; }
