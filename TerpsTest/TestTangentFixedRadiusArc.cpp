...
//  CGeoCalcs geo1;
    ...
    if(nIndex == 0)
    {
        ...
        {
            cout << "\n" << soTestId << " failed: Expected Arc direction: " << soArcDirection << "  calced: " << arcDirection;
            bPassed = false;
        }
        ...
        if(sArcCenterLat.compare(soArcCenterLat) != 0)
        {
            ...
            {
                cout << "\n" << soTestId << " within rounding tolerance of 1e-10: Input Arc center latitude: " << soArcCenterLat << "  calced: " << sArcCenterLat;
            } else {
                cout << "\n" << soTestId << " failed: Expected Arc center latitude: " << soArcCenterLat << "  calced: " << sArcCenterLat;
                bPassed = false;
            }
        }
        ...
        if(sArcCenterLon.compare(soArcCenterLon) != 0)
        {
            ...
            {
                cout << "\n" << soTestId << " within rounding tolerance of 1e-10: Input Arc center longitude: " << soArcCenterLon << "  calced: " << sArcCenterLon;
            } else {
                cout << "\n" << soTestId << " failed: Expected Arc center longitude: " << soArcCenterLon << "  calced: " << sArcCenterLon;
                bPassed = false;
            }
        }
        ...
        if(sTan1Lat.compare(soTangentPt1Lat) != 0)
        {
            ...
            {
                cout << "\n" << soTestId << " within rounding tolerance of 1e-10: Input Tangent pt 1 latitude: " << soTangentPt1Lat << "  calced: " << sTan1Lat;
            } else {
                cout << "\n" << soTestId << " failed: Expected Tangent pt 1 latitude: " << soTangentPt1Lat << "  calced: " << sTan1Lat;
                bPassed = false;
            }
        }
        ...
        if(sTan1Lon.compare(soTangentPt1Lon) != 0)
        {
            ...
            {
                cout << "\n" << soTestId << " within rounding tolerance of 1e-10: Input Tangent pt 1 longitude: " << soTangentPt1Lon << "  calced: " << sTan1Lon;
            } else {
                cout << "\n" << soTestId << " failed: Expected Tangent pt 1 longitude: " << soTangentPt1Lon << "  calced: " << sTan1Lon;
                bPassed = false;
            }
        }
        ...
        if(sTan2Lat.compare(soTangentPt2Lat) != 0)
        {
            ...
            {
                cout << "\n" << soTestId << " within rounding tolerance of 1e-10: Input Tangent pt 2 latitude: " << soTangentPt2Lat << "  calced: " << sTan2Lat;
            } else {
                cout << "\n" << soTestId << " failed: Expected Tangent pt 2 latitude: " << soTangentPt2Lat << "  calced: " << sTan2Lat;
                bPassed = false;
            }
        }
        ...
        if(sTan2Lon.compare(soTangentPt2Lon) != 0)
        {
            ...
            {
                cout << "\n" << soTestId << " within rounding tolerance of 1e-10: Input Tangent pt 2 longitude: " << soTangentPt2Lon << "  calced: " << sTan2Lon;
            } else {
                cout << "\n" << soTestId << " failed: Expected Tangent pt 2 longitude: " << soTangentPt2Lon << "  calced: " << sTan2Lon;
                bPassed = false;
            }
        }
